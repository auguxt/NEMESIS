...
def calculate_speed(attacks):
    """Calculate attack speed: fast, medium, or slow"""
    if len(attacks) < 2:
        return "slow"
...
def classify_attacker(ip):
    """Classify an attacker into a category"""
...
# ─────────────────────────────────────────
def profile_all():
    """Profile every attacker in database"""
